  ...
  return (
    <section>
      <button type='button' className='relative flex' onClick={() => setOpenBtn(!openBtn)}>
        {openBtn ? <IconX className='rounded-md border border-current' /> : <IconMenu2 width={26} height={26} />}
      </button>

      {openBtn &&
        (
          <div className='mainContent absolute h-fit shadow-md left-0 right-0 top-[50px] bottom-0 bg-neutral-200 px-4 md:px-10 pb-10 pt-5'>
            ...
            {(isSignedIn && pathname === '/dashboard') &&
              (
                <div className='flex flex-col mt-2.5'>
                  ...
                  <h5 className='flex items-center justify-between mt-2.5 font-medium text-xs'>
                    The session is in mode {getSessionStatus()}
                  </h5>
